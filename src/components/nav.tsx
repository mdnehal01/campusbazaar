...
function Nav() {
  return (
    <div className="h-20 px-10 w-full bg-white/50 font-semibold text-slate-600">
        <div className="nav-items rounded-md h-full w-full flex items-center justify-between">
          <div className="nav-logo w-50 bg-[#EBF0FE] px-10 py-2 rounded-3xl">Campus Bazaar</div>        
          ...
          <div className="nav-theme-cart flex gap-5">
            ...
            <div className="nav-theme w-50 bg-[#EBF0FE] px-5 py-2 rounded-3xl flex gap-5"> <BiSun className='cursor-pointer' size={25}/>  <BiMoon className='cursor-pointer' size={25} /> </div>
            <div className="nav-cart w-50 bg-[#EBF0FE] px-5 py-2 rounded-3xl flex gap-2"> <CgShoppingCart className='cursor-pointer' size={25} />  Cart</div>
          </div>
