...
function Signup() {
    ...
    <div className="main h-[90.5vh] flex">
        ...
        <div className="shadow-lg box flex absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 h-[65%] w-[52%] bg-transparent border-white border-8 rounded-xl ">
            <div className="box-left h-full w-[40%] bg-transparent bg-center bg-cover rounded-l-xl" style={{backgroundImage:`url('/images/boo-signup.png')`}}></div>
            <div className="box-right h-full w-[60%] bg-white">
