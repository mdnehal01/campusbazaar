...
function Signup() {
    ...
    <div className="main h-screen flex">
        <div className="left h-full w-[70%] bg-blue-50 bg-center bg-contain" style={{backgroundImage:`url(/images/boo-signup.png)` , opacity:0.1}}></div>
        ...
        <div className="box flex absolute top-[200px] left-[400px] h-[60%] w-[50%] bg-transparent border-white border-8 rounded-3xl ">
            <div className="box-left h-full w-[40%] bg-transparent bg-center bg-cover" style={{backgroundImage:`url('/images/boo-signup.png')`}}></div>
